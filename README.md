...
- [x] Home screen with welcome label
- [x] Write screen with UITextView to enter gratitude
- [x] Save entry using UserDefaults
- [x] Alert confirmation when entry is saved
...
3. MoodSnap (Daily selfie + mood tracker)
4. TimeCapsule (Send notes to future self)
5. QuoteSpark (Favorite quote collection)
6. StudyBuddy (Pomodoro timer + progress)
